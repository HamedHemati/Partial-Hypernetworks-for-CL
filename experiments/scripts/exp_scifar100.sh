...
python -m experiments.train_incremental --multirun \
        experiment=latentreplay1_scifar100 n_classes=5  input_size=32 description="exp-2_scifar100" \
        ...
        end_after_n_exps=Null  wandb_proj=HyperCL save_results=True

# HyperResNet
python -m experiments.train_incremental --multirun \
        experiment=hyper-alg-reg-NM_scifar100 n_classes=10 input_size=32 description="exp-2_scifar100" \
...
# Naive
python -m experiments.train_incremental --multirun \
        experiment=baseline_scifar100 n_classes=5  input_size=32 description="exp-2_scifar100" \
